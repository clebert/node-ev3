...
ButtonHolder.prototype.check = function () {
    var pressed = this.button.pressed;
...
function init() {
    ...
    names.forEach(function (name) {
        ...
        nameToButtonHolder[name] = new ButtonHolder(getButtonState);
    });

    names.forEach(function (name) {
        Object.defineProperty(exports, name.toLowerCase(), {
            value: nameToButtonHolder[name].button
        });
    });
